...
const PROVIDER_DESCRIPTIONS: Record<AIProvider, string> = {
    OPENAI: 'GPT-4o, GPT-4o Mini, GPT-3.5 Turbo — Advanced reasoning and code generation',
    GEMINI: 'Gemini 2.0 Flash, 1.5 Pro, and more — Multimodal, long context, Google-grade intelligence',
};
        ...
        <div style={{ padding: '36px 40px', maxWidth: 900 }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 24, alignItems: 'start' }}>
                ...
                <div className="glass-card" style={{ padding: 28 }}>
                    ...
                    <form onSubmit={handleSave} style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
                        ...
                        <div>
                            ...
                            {selectedProvider === 'GEMINI' && (
                                <p style={{ fontSize: '0.72rem', color: 'var(--text-muted)', marginTop: 5 }}>
                                    💡 Recommended: <strong style={{ color: '#4285f4' }}>gemini-2.0-flash</strong> — fastest & most capable free-tier model
                                </p>
                            )}
                        </div>
                ...
                <div>
                    ...
                    >
                        <div style={{ fontWeight: 600, fontSize: '0.82rem', color: '#4285f4', marginBottom: 6 }}>
                            ✦ Gemini API Key Tips
                        </div>
                        <ul style={{ color: 'var(--text-muted)', fontSize: '0.78rem', lineHeight: 1.7, paddingLeft: 16 }}>
                            <li>Get your free key at <a href="https://aistudio.google.com/apikey" target="_blank" rel="noreferrer" style={{ color: '#4285f4' }}>aistudio.google.com/apikey</a></li>
                            <li>Use <strong style={{ color: 'var(--text-secondary)' }}>gemini-2.0-flash</strong> — available on free tier</li>
                            <li>If test fails, try deleting and re-adding the connection with the correct model</li>
                            <li>Keys starting with <code style={{ background: 'rgba(255,255,255,0.05)', padding: '1px 4px', borderRadius: 3 }}>AIza</code> are valid Gemini keys</li>
                        </ul>
                    </div>
                </div>
            </div>
